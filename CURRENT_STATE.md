...
2026-09-22追記：PC・16:9向けに冒頭を40:60の2列へ再構成した。現在議席・改選範囲は表、論点は3つの要点、右側は共通100議席尺度の3本の比較とした。概説全体の開閉は廃止し、詳細ごとの開閉へ変更。数値・ニュース・保存形式は維持。[設計・検証記録](docs/pc-opening-layout-20260922.md)を参照。119テストと本番ビルドは成功。PR・公開画面確認はこの記録時点では未完了。
