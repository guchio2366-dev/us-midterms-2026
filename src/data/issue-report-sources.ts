...
export const issueReportSources: Source[] = [
  {sourceId:'issue-peltola-veterans',title:'Keeping our Promise to Alaska Veterans and Servicemembers',publisher:'Mary Peltola for U.S. Senate',url:'https://marypeltola.com/veterans/',publishedAt:null,referencePeriod:'2026-09-14閲覧時点の候補者公約',retrievedAt:'2026-09-14',contentVerifiedAt:'2026-09-14'},
...
export const issueReportEvidence: EvidenceRef[] = [
  {evidenceId:'ev-issue-peltola-veterans',sourceId:'issue-peltola-veterans',locator:'Strengthen and Expand VA Healthcare / Put Military Families First：医療・給付・軍人家族の生活費支援',checkedAt:'2026-09-14',kind:'observed'},
  {evidenceId:'ev-issue-elsayed-foreign',sourceId:'issue-elsayed-institutions',locator:'Sensible Foreign Policy：イランでの敵対行為停止、対中競争、軍事支援条件についての本人公約。紛争の法的評価を独立検証したものではない',checkedAt:'2026-09-14',kind:'observed'},
