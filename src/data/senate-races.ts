...
export const senateRaceSources: Source[] = [
  ...
  {sourceId:'inside-senate-ratings-2026',title:'2026 Senate Ratings',publisher:'Inside Elections',url:'https://insideelections.com/ratings/senate',publishedAt:null,updatedAt:'2026-09-03',referencePeriod:'全35選挙の現行情勢評価。Tiltを含む元分類を保持',retrievedAt:'2026-09-13',contentVerifiedAt:'2026-09-13'},
];
